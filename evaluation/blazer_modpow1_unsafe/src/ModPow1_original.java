 ...
 */
    ...
    public static BigInteger modPow1_safe(BigInteger base, BigInteger exponent, BigInteger modulus) {
    ...
    public static BigInteger modPow1_unsafe(BigInteger base, BigInteger exponent, BigInteger modulus) {
        BigInteger s = BigInteger.valueOf(1);
        int width = exponent.bitLength();
        for (int i = 0; i < width; i++) {
            s = s.multiply(s).mod(modulus);
